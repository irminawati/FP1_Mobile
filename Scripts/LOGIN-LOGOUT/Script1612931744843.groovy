...
Mobile.setText(findTestObject('Login/Stext_Username'), 'kurniawati', 3)

Mobile.setEncryptedText(findTestObject('Login/Stext_Password'), 'OjI3K2/1R31ymFbmPOJ3cg==', 0)

Mobile.tap(findTestObject('Login/Button_Login'), 0, FailureHandling.STOP_ON_FAILURE)
